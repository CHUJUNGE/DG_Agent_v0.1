...
- “关于我”模块需要覆盖自我介绍、学业/工作、居住空间、兴趣爱好、社交生活、理想生活、焦虑/压力、生活评分等维度；固定开场题全文由 `dg-question-wording-editor` 维护。
- “我典型的一天”应覆盖 routine、吃饭类型、餐前餐后行为、不同时间段状态、工作日和周末差异。
...
- 购物任务用于验证真实购买路径和卡点：第 4-5 天布置；高频用户自然购买可视作完成，低频/流失用户不强制渠道。
...
- 受访者题面表达由 `dg-question-wording-editor` 处理，本 case card 只保留研究逻辑。

## 8. Wording Handoff Notes

For Case_001-like projects, pass these notes to `dg-question-wording-editor`:

- Preserve the About Me fixed opening template from the wording skill.
- Keep brand/product intent out of the About Me opening and early routine modules.
- Convert diary and shopping tasks into low-burden respondent wording without changing the research chain.
- Avoid exposing Doublemint / Extra internal branches in respondent-facing wording.
