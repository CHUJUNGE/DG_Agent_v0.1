...
DESIGNER_SKILL_REFERENCES_DIR = ROOT / "skill" / "dg-questionnaire-designer" / "references"
GENERATION_LOGIC_PATH = DESIGNER_SKILL_REFERENCES_DIR / "generation_logic.md"
RESEARCH_RULES_PATH = DESIGNER_SKILL_REFERENCES_DIR / "research_rules.md"
RESEARCH_DESIGN_AI_AGENT_RULES_PATH = DESIGNER_SKILL_REFERENCES_DIR / "research_design_ai_agent_rules.md"
CASE_CARDS_DIR = DESIGNER_SKILL_REFERENCES_DIR
...
8. 如果用户反馈题目“死板、太多解释、太像 checklist、太命令式”，保留研究逻辑，输出受影响模块的 Wording Handoff，交给 dg-question-wording-editor 处理。
""".strip()
